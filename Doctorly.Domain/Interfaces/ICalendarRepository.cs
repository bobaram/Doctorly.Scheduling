...
public interface ICalendarRepository
{
    ...
    Task<IEnumerable<CalendarEvent>> ListAsync(DateTime from, DateTime to, CancellationToken ct = default);
    Task<IEnumerable<CalendarEvent>> SearchAsync(string query, CancellationToken ct = default);
